...
import { Diagnostic, LocationAccuracy, Geolocation, BackgroundGeolocation, SMS, Sim, Contacts, ContactField, ContactFindOptions, ImageResizer, ImageResizerOptions, File } from 'ionic-native';
