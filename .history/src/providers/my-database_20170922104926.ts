  ...
  public loadDatabase(){
    return new Promise((resolve) => {
      ...
      this.storage.openDatabase({name: "data.db", location: "default"}).then(() => {
        ...
        this.storage.executeSql("CREATE TABLE IF NOT EXISTS sms_unsent (id INTEGER PRIMARY KEY, creator_id INT, msg TEXT, numbers TEXT, sync INT)", []);
        this.storage.executeSql("CREATE TABLE IF NOT EXISTS carriers (id INTEGER PRIMARY KEY, carrier TEXT, prefix TEXT)", []);
        this.storage.executeSql("CREATE TABLE IF NOT EXISTS coverage_area (id INTEGER PRIMARY KEY, creator_id INT, area TEXT, sync INT)", []);
