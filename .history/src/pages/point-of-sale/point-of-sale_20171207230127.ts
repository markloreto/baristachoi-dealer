...
export class PointOfSalePage {
  ...
  distance:any
  machine: any
  constructor(private tts: TextToSpeech, public navCtrl: NavController, public navParams: NavParams, public myFunctions: MyFunctions, public myDatabase: MyDatabase, private alertCtrl: AlertController) {
  ...
  speak(){
    ...
    this.tts.speak({text: "Mahal kita ging!", locale: "en-PH", rate: 0.7})
