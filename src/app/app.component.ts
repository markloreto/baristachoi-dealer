...
import { Platform, MenuController, Nav, Events, AlertController, IonicApp } from 'ionic-angular';
...
export class MyApp {
  ...
  initializeApp() {
    this.platform.ready().then(() => {
      ...
      this.platform.registerBackButtonAction(() => {
        ...
        let page = nav ? this.nav.getActive().instance : null;
  ...
  openPage(page) {
    ...
    if ( view.instance instanceof page.component ){
      ...
      if(!this.myFunctions.synching && this.myDatabase.isOnline){
        this.myFunctions.sync()
      }
